...
public class TestList {
	...
	public void setUp() throws Exception {
		//list = new ArrayList<Integer>(); // 3 ms
		list = new LinkedList<Integer>(); // 3 ms
	...
	public void testSet() {
		...
		list.set(1, Integer.valueOf(99));
		list.set(3, Integer.valueOf(99));
		list.set(5, Integer.valueOf(99));
